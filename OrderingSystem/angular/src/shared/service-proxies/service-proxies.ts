...
export class FoodServiceProxy {
     ...
     * @return Success
     */
    getAllFoodFromCategories(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<FoodDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Food/GetAllFoodFromCategories?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllFoodFromCategories(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllFoodFromCategories(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FoodDtoPagedResultDto>;
                }
            } else
    ...
    protected processGetAllFoodFromCategories(response: HttpResponseBase): Observable<FoodDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getAllFoodWithTypes(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<FoodDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Food/GetAllFoodWithTypes?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllFoodWithTypes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllFoodWithTypes(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FoodDtoPagedResultDto>;
                }
            } else
    ...
    protected processGetAllFoodWithTypes(response: HttpResponseBase): Observable<FoodDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
